...
class bpskfile5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(0, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.qtgui_edit_box_msg_0_0 = qtgui.edit_box_msg(qtgui.STRING, '', 'Recieve', False, False, '', None)
        ...
        self.qtgui_edit_box_msg_0 = qtgui.edit_box_msg(qtgui.STRING, '', 'Transmission', False, True, '', None)
        ...
        self.msg_connect((self.epy_block_1, 'msg_out'), (self.qtgui_edit_box_msg_0_0, 'val'))
