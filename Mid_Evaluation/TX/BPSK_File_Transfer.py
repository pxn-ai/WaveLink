...
class BPSK_File_Transfer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Plut_SDR_File_TX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Plut_SDR_File_TX")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "BPSK_File_Transfer")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/pxn-ai/Downloads/color_test_800x600_118kb.jpg', False, 0, 0)
...
def main(top_block_cls=BPSK_File_Transfer, options=None):
