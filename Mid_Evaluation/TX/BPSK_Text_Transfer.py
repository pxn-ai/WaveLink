...
import BPSK_Text_Transfer_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading
...
class BPSK_Text_Transfer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Pluto_SDR_Text_TX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Pluto_SDR_Text_TX")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "BPSK_Text_Transfer")
...
def main(top_block_cls=BPSK_Text_Transfer, options=None):
