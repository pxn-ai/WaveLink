...
import BPSK_Recieve_RTL_GUI_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class BPSK_Recieve_RTL_GUI(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BPSK_Recieve_RTL_GUI", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK_Recieve_RTL_GUI")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "BPSK_Recieve_RTL_GUI")
        ...
        self.top_grid_layout.addWidget(self._rfGain_tool_bar, 0, 0, 1, 3)
        for r in range(0, 1):
...
def main(top_block_cls=BPSK_Recieve_RTL_GUI, options=None):
