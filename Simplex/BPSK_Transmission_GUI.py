...
import BPSK_Transmission_GUI_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading
...
class BPSK_Transmission_GUI(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BPSK_Transmission_GUI", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK_Transmission_GUI")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "BPSK_Transmission_GUI")
        ...
        self.top_grid_layout.addWidget(self._tx_atten_win, 0, 0, 1, 3)
        for r in range(0, 1):
...
def main(top_block_cls=BPSK_Transmission_GUI, options=None):
